...
*/
	...
	//drop menu when item is clicked
	$('#mobile-menu-pro li a').click(() => {
		$('#mobile-navigation-pro').hide();
		$('header#masthead-pro').toggleClass('active-mobile-icon-pro');
		$('header#videohead-pro').toggleClass('active-mobile-icon-pro');
	});

	//drop entire menu except search bar when search bar is clicked
	$('#search-mobile-nav-pro').click(() => {
		$('#mobile-navigation-pro').hide();
		$('header#masthead-pro').toggleClass('active-mobile-icon-pro');
		$('header#videohead-pro').toggleClass('active-mobile-icon-pro');
	});
